...
function KeySkills4() {
 const [show,hide] = useState()
  ...
  const onSubmit = (data) => {
    ...
    navigate("/Template4/Education4",{state: WorkE_PersI_KeyS})
          ...
          <div style={{ width: "85% " }} className='mx-auto'>
            ...
            <form onSubmit={handleSubmit(onSubmit)}>
              ...
              <div className='d-flex justify-content-end me-sm-5 '>
                <Link className='btn btn-outline-primary PersonalInfo_btn mx-3' to="/Template4/WorkExperience4">Back</Link>
