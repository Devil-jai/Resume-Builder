...
import { addTemplate_4_User } from "../../../../redux utilities/Template_4_slice";
...
function Education4() {
  ...
  const onSubmit = (data) => {
    ...
    dispatch(addTemplate_4_User(allformsdata))
    navigate('/Template_4')
  };
        ...
        <div className="Education_div ms-lg-5   py-4 pt-5 mt-2">
          <div style={{ width: "85% " }} className="mx-auto">
           ...
           <MenuItem value={"Present"}>Present</MenuItem>
              ...
              <Link className='btn btn-outline-primary PersonalInfo_btn mx-3' to="/Template4/KeySkills4">Back</Link>
