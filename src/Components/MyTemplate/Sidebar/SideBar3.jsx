          ...
          <ul className="navbar-nav  flex-column nav_list  list-group ">
            <li className="nav-item nav_list_item  justify-content-center  d-flex list-group-item ps-0 ">
              ...
              <NavLink
                ...
                aria-current="page"
                style={{ color: getcolor("/Template3/PersonalInfo3") }}
              >
                Personal Info
              </NavLink>
            </li>
            <li className="nav-item nav_list_items  justify-content-center d-flex list-group-item ps-0">
              <span
                ...
                style={{
                  backgroundColor: getbackgroundcolor(
                    "/Template3/WorkExperience3"
                  ),
                  width: "3px",
                }}
              ></span>
              <NavLink
                style={{ color: getcolor("/Template3/WorkExperience3") }}
                className="nav-link  home mx-auto "
              >
                Work Experience
              </NavLink>
            ...
            <li className="nav-item nav_list_items  justify-content-center d-flex list-group-item ps-0">
              <span
                className="ms-0 ps-0"
                style={{
                  backgroundColor: getbackgroundcolor("/Template3/KeySkills3"),
                  width: "3px",
                }}
              ></span>
              <NavLink
                className="nav-link  home  mx-auto"
                style={{ color: getcolor("/Template3/KeySkills3") }}
              >
                Key Skills
              </NavLink>
            </li>
            <li className="nav-item nav_list_items  justify-content-center d-flex list-group-item ps-0">
              <span
                className="ms-0 ps-0"
                style={{
                  backgroundColor: getbackgroundcolor("/Template3/Education3"),
                  width: "3px",
                }}
              ></span>
              <NavLink
                className="nav-link  home  mx-auto  "
                style={{ color: getcolor("/Template3/Education3") }}
              >
                Education
              </NavLink>
            </li>
