...
import { addTemplate_2_User } from '../../../../redux utilities/Template_2_slice'
...
function Education2() {
  ...
  const onSubmit = (data) => {
    ...
    dispatch(addTemplate_2_User(allformsdata))
    navigate('/Template_2')
  };
          ...
          <div style={{ width: "85% " }} className="mx-auto">
            ...
            <Grid container spacing={2}>
             ...
             <MenuItem value={"Present"}>Present</MenuItem>
              ...
              <Link className='btn btn-outline-primary PersonalInfo_btn mx-3' to="/Template2/KeySkills2">Back</Link>
