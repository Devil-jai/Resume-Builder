...
function KeySkills2() {
  ...
  const onSubmit = (data) => {
    ...
    navigate("/Template2/Education2",{state: WorkE_PersI_KeyS})
          ...
          <div style={{ width: "85% " }} className='mx-auto'>
            ...
            <form onSubmit={handleSubmit(onSubmit)}>
              ...
              <div className='d-flex justify-content-end me-sm-5 '>
                <Link className='btn btn-outline-primary PersonalInfo_btn mx-3' to="/Template2/WorkExperience2">Back</Link>
